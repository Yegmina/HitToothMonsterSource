...
public class PlaceManager : MonoBehaviour {
	...
	public void SpeedChangeMultipier(float multiplierspeed)
	{
		//if (addingspeed!=0) {
		//moveSpeed=moveSpeed+addingspeed;
		//}
		if (multiplierspeed!=0)
			moveSpeed=moveSpeed*multiplierspeed;
		
	}
	public void RespawnTimeMultiplier(float multipliertimeToRespawn)
	{
		timeToRespawn=timeToRespawn*multipliertimeToRespawn;
